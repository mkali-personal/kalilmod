...
3. Tell the student to pick a lesson in the browser. For live tutoring, they can run **`/tutor`** here once to go hands-free (you react to the browser automatically); otherwise they run **`/review-answer`** whenever they submit a free-text answer or leave feedback.
